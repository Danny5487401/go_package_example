...
线性读 ：一旦一个值更新成功，随后任何通过线性读的 client 都能及时访问到。虽然集群中有多个节点，但 client 通过线性读就如访问一个节点一样。etcd 默认读模式是线性读，
...
## 2. 写请求
![readIndex](.etcd_read_n_write_images/request_wirte_process.png)
